...
```
📊 REVISÃO SEMANAL DE ADS — [DATA]

META ADS
━━━━━━━━
[CBO Toguro] CPL: R$XX (▲/▼ X% vs semana anterior)
[TOPO F] CPL: R$XX (▲/▼ X% vs semana anterior)
...
...
## Periodicidade
- **Semanal**: toda segunda-feira (automação ads-06 já faz versão básica)
