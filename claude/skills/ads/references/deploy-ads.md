...
Description: Deploy em massa de campanhas via Meta API. Triggera em: "/deploy-ads", "cria campanhas em massa", "sobe campanhas do manifest", "deploy de anúncios". ATENÇÃO: skill de alto risco — sempre usar --dry-run primeiro.
...
7. Gerar relatório: `./reports/deploy-YYYY-MM-DD-HHmm.md`
   Com: IDs criados, links diretos para o Ads Manager, erros, contagem de chamadas API.
