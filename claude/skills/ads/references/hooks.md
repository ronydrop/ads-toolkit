...
Description: Motor de variações de copy e hooks. Triggera em: "/hooks", "gera variações de copy", "50 variações de anúncio", "frameworks de copy", "PAS", "BAB", "AIDA", "pattern interrupt", "variações de headline".
...
Carregue `ad-copy-principles.md` e `account-conventions.md` antes.
