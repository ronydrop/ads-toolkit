...
Description: Inteligência competitiva de anúncios via Meta Ad Library API. Triggera em: "o que concorrente está anunciando", "espia concorrente", "ads da concorrência", "/spy", "inteligência competitiva", "o que [marca] está rodando".
...
## Concorrentes do Setor (Aprovei Pay — preencher)
