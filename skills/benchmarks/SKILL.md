---
name: benchmarks
description: Benchmarks de performance de ads para 2026 (Google Ads, Meta Ads, landing pages). Carregar automaticamente em auditorias e análises de performance. NÃO invocar diretamente pelo usuário.
---

# Benchmarks de Ads 2026

Fonte: WordStream/LocaliQ (16K campanhas), Triple Whale 2025, pesquisa Claude.
Valores originais em USD — converter para BRL conforme necessário (x5.80).
