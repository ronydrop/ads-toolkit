...
description: Metodologia padrão para análise de performance de campanhas Meta e Google Ads. Triggers on "analisa performance", "métricas", "CPL", "CPA", "CTR", "como está a campanha".
---
