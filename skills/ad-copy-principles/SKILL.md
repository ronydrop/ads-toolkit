...
## Tom e Voz
- Sempre persuasivo, direto ao resultado
...
- 4 descrições, máx 90 chars cada
- Pelo menos 3 headlines com keyword principal
- Pelo menos 3 com proposta de valor clara
- Pelo menos 2 com CTA explícito
...
- 98% de aprovação nas vendas
- Taxas personalizadas / sob medida
- Sem bloqueio de saldo
- Receba Pix, Cartão e Boleto
- API fácil de integrar
- Atendimento 24h no WhatsApp
- Gateway multiadquirente

## Proibições
- Promessas não verificáveis sem dados ("o melhor gateway do Brasil")
- Copy genérica sem diferencial claro
- Headlines duplicadas ou muito parecidas no mesmo anúncio
- Urgência falsa sem oferta real
