---
name: audience-audit
description: Auditoria de arquitetura de audiências Meta Ads. Triggers on "analisa públicos", "sobreposição de audiências", "públicos se sobrepondo", "lookalike", "exclusões faltando", "público canibaliza".
---
...
EXCLUSÕES FALTANDO:
ALTO: Leads existentes não excluídos das campanhas frias
MÉDIO: Retargeting não excluído do topo
