...
Description: This skill should be used when mining search terms, finding negative keyword candidates, identifying new keyword opportunities, or evaluating whether a search term is relevant to a campaign. Triggers on "search terms", "negative keywords", "search term report", "mine", "wasted spend", "irrelevant queries", or "keyword opportunities".
